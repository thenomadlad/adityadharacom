<script lang="ts">
	...
	import WavingHand from '$lib/components/waving_hand.svelte';
	import LanguageIcon from '$lib/components/language_icon.svelte';
...
<main class="container mx-auto">
	<div class="flex">
		<div class="m-auto inline-grid gap-y-20 justify-center items-center">
			...
			<div class="inline-grid xl:grid-cols-4 lg:grid-cols-3 grid-cols-2 gap-x-4 gap-y-4">
	...
	<div class="flex align-center justify-center border-t-2 mt-10 mb-10">
		<p class="text-slate-400">Woah you reached the end!</p>
	</div>
</main>
